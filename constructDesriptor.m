function descriptor = constructDesriptor(orientation, keypoints)
...
for octave = 1:size(keypointDescriptor, 1)
    for kptLayer = 1:size(keypointDescriptor,2)    
        ...
        keypointData = orientation{1}{octave}{kptLayer};   
        magnitudes = orientation{2}{octave}{kptLayer}{1};
        orientations = orientation{2}{octave}{kptLayer}{2};
        %for each keypoint
